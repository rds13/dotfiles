...
```sh
git clone https://github.com/rds13/dotfiles ~/.dotfiles
cd ~/.dotfiles
script/bootstrap
```
...
[Fork it](https://github.com/rds13/dotfiles/fork), remove what you don't
...
[open an issue](https://github.com/rds13/dotfiles/issues) on this repository
and I'd love to get it fixed for you!

## thanks

I forked [Zach Holman](http://github.com/holman) who forked
